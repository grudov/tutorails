...
describe User do
  ...
  it "Devrait cree une nouvelle instance dotee des attributs valides" do
    User.create!(@attr)
  end
  ...
  it "devrait rejeter une adresse mail invalide" do
  ...
  describe "password validations" do
    ...
    it "devrait rejeter les (trops) longs mots de passe" do
      long = "a" * 41
